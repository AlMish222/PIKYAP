...
def list_directories_with_files_with_keyword(fileDirectories: List[FileDirectory], fileInTheFileDirectories: List[FileInTheFileDirectory], keyword: str = "язык") -> Dict[str, List[str]]:
    result = {}
...
# Вывод запросов
print("Запрос A1")
print(list_files_in_the_directory(files, fileDirectories))

print("\nЗапрос A2")
print(list_file_directories_with_total_file_volume(files, fileDirectories))

print("\nЗапрос A3")
print(list_directories_with_files_with_keyword(fileDirectories, fileInTheFileDirectories))